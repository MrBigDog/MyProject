...
namespace gwEarth
{
	...
	public:
		...
		{
			if (_currentCameraManipulator == currendCm) return;
	...
	{
		//addCameraManipulator(FIRST_PERSONAL, new FirstPersonManipulator());
