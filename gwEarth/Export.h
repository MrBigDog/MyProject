#ifndef GWEARTH_EXPORT_H
#define GWEARTH_EXPORT_H 1
...
#  if defined( GWEARTH_LIBRARY_STATIC )
#    define GWEARTH_EXPORT
#  elif defined( GWEARTH_LIBRARY )
#    define GWEARTH_EXPORT   __declspec(dllexport)
#  else
#    define GWEARTH_EXPORT   __declspec(dllimport)
#  endif
#else
#  define GWEARTH_EXPORT
#endif  
