#ifndef GWAPP_EXPORT_H
#define GWAPP_EXPORT_H 1
...
#  if defined( GWAPP_LIBRARY_STATIC )
#    define GW_APP_EXPORT
#  elif defined( GWAPP_LIBRARY )
#    define GW_APP_EXPORT   __declspec(dllexport)
#  else
#    define GW_APP_EXPORT   __declspec(dllimport)
#  endif
#else
#  define GW_APP_EXPORT
#endif  
