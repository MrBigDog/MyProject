/*
*  这个插件本质上还是FEATURE_WFS插件，当然在此基础上添加了些Pipeline特殊需求，
*  这里重写这个插件的原因是 osgEarth当前版本的feature_filter功能还不能用，等
*  feature_filter功能能用后，用PipelineResetAltFilter代替。--BigDog 2017.02.14
*/
