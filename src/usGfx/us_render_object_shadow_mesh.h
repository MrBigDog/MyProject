...
///////////////////////////////////////////////////////////////////////////
//
//  Filename: us_render_object_shadow_mesh.h
...
//
///////////////////////////////////////////////////////////////////////////
#ifndef _US_RENDER_OBJECT_SHADOW_MESH_H_
#define _US_RENDER_OBJECT_SHADOW_MESH_H_
...
{
	class USGFX_EXPORT render_object_shadow_mesh
		: public render_object
		//, public intersect_base
	{
	public:
		render_object_shadow_mesh(void);

		virtual ~render_object_shadow_mesh(void);

		friend class render_object_shadow_factory;

	public:
		static render_object_shadow_mesh* create_shared_instance();
...
#endif // _US_RENDER_OBJECT_SHADOW_MESH_H_ 