...
namespace uniscope_globe
{
	...
	void render_object_line_flake::draw( render_argument* args )
	{
		...
		matrix_4d v_world_mat_d = m_collapse_matrix * m_trans_matrix;
		...
		matrix_4f v_mat_clip = args->m_device->get_clip_matrix();
		matrix_4f v_mat_view_project = v_mat_view * v_mat_project * v_mat_clip;
	...
	//		//v_render->set_line_color()
	//		v_render->commit_changes();
	//		args->m_device->draw_triangle_strip( (void*)v_vertex_array[0], vertices_count , sizeof(transformed_color) );
	//		v_render->end_pass();
	//	}
	//	v_render->end();
	//}
	...
	//int render_object_line_flake::project_line( std::vector<transformed_color>& out_vec_array, std::vector<position_normal_color>& in_vec_array, view_port& viewport, matrix_4f& proj_mat, matrix_4f& view_mat, matrix_4f& world_mat, float near_plane )
	//{
	...
	//vector_3f render_object_line_flake::project2(vector_3f& vector_in_world, view_port& viewport, matrix_4f& wvp)
	//{
	//	//vector_3f v_out;
	...
	//vector_3f render_object_line_flake::project(vector_3f& vec, view_port& viewport, matrix_4f& wvp)
	//{
	//	vector_3f v_out;
	//	vector_3f vec_trans = matrix_4f::transform_coordinate( vec, wvp);
	...
	//	//args->m_device->draw_point_list( (void*)m_vertex_array[0], vertices_count , sizeof(position_normal_color) );
	//	args->m_device->draw_line_strip( (void*)m_vertex_array[0], vertices_count , sizeof(position_normal_color) );
	...
	//void render_object_line_flake::create_from_line_string( vector_3d* v_src, int v_size, ulong v_color )
	//{
	//	m_vertex_array.clear();
	...
	//bool render_object_line_flake::intersect( const point& pt, intersect_result& out_result )
	//{
	//	bool ret_val = false;
