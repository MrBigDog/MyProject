...
///////////////////////////////////////////////////////////////////////////
//
//  Filename: us_geometry_shadow_mesh.cpp
...
{
	geometry_shadow_mesh::geometry_shadow_mesh( void )
	{
	...
	geometry_shadow_mesh* geometry_shadow_mesh::create_shared_instance()
	{
		geometry_shadow_mesh* v_geometry = new geometry_shadow_mesh();
		v_geometry->add_ref();
		return v_geometry;
	}

	void geometry_shadow_mesh::draw( render_argument* args )
	{
	...
	void geometry_shadow_mesh::clear()
	{
	...
	void geometry_shadow_mesh::set_collapse( matrix_4d& mat )
	{
		m_collapse_matrix = m_collapse_matrix * mat;
	}
	
	bool geometry_shadow_mesh::intersect( const ray<double>& a_ray, intersect_result& result )
	{
		bool b_ret = false;
