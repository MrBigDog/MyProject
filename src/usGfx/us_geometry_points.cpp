...
///////////////////////////////////////////////////////////////////////////
//
//  Filename: us_geometry_points.cpp
...
///////////////////////////////////////////////////////////////////////////
#include "stdafx.h"
#include "us_geometry_points.h"

namespace uniscope_globe
{
	geometry_points::geometry_points( void )
	{
	...
	void geometry_points::draw( render_argument* args )
	{
		...
		args->m_device->draw_point_list( (void*)m_vertex_array.begin()._Myptr, vertices_count , sizeof(position_color) );

		args->m_device->pop_transform();
	}

	void geometry_points::set_matrix( matrix_4f& mat )
	{
		m_mat = mat;
	}

	void geometry_points::create_from_point_list( vector_3d* v_src, int v_size, ulong v_color )
	{
		m_vertex_array.clear();
