...
///////////////////////////////////////////////////////////////////////////
//
//  Filename: us_d3d9_wave_file.cpp
...
///////////////////////////////////////////////////////////////////////////
//#include "stdafx.h"
#include "us_d3d9_wave_file.h"

namespace uniscope_globe
{
	d3d9_wave_file::d3d9_wave_file( void )
	{
		m_pwfx    = NULL;
		m_hmmio   = NULL;
	...
	//-----------------------------------------------------------------------------
	// Name: d3d9_wave_file::~d3d9_wave_file()
	...
	d3d9_wave_file::~d3d9_wave_file( void )
	{
		...
		if( !m_bIsReadingFromMemory )
			AUTO_DELETE_ARRAY( m_pwfx );
	}


	//-----------------------------------------------------------------------------
	// Name: d3d9_wave_file::Open()
	// Desc: Opens a wave file for reading
	//-----------------------------------------------------------------------------
	HRESULT d3d9_wave_file::open( LPWSTR strFileName, WAVEFORMATEX* pwfx, DWORD dwFlags )
	{
		HRESULT hr;
	...
	//-----------------------------------------------------------------------------
	// Name: d3d9_wave_file::OpenFromMemory()
	// Desc: copy data to d3d9_wave_file member variable from memory
	//-----------------------------------------------------------------------------
	HRESULT d3d9_wave_file::open_from_memory( BYTE* pbData, ULONG ulDataSize, WAVEFORMATEX* pwfx, DWORD dwFlags )
	{
		m_pwfx       = pwfx;
	...
	//-----------------------------------------------------------------------------
	// Name: d3d9_wave_file::read_mmio()
	// Desc: Support function for reading from a multimedia I/O stream.
	//       m_hmmio must be valid before calling.  This function uses it to
	//       update m_ckRiff, and m_pwfx.
	//-----------------------------------------------------------------------------
	HRESULT d3d9_wave_file::read_mmio()
	{
	...
	//-----------------------------------------------------------------------------
	// Name: d3d9_wave_file::GetSize()
	// Desc: Retuns the size of the read access wave file
	//-----------------------------------------------------------------------------
	DWORD d3d9_wave_file::get_size()
	{
		return m_dwSize;
	}
	...
	//-----------------------------------------------------------------------------
	// Name: d3d9_wave_file::ResetFile()
	// Desc: Resets the internal m_ck pointer so reading starts from the
	//       beginning of the file again
	//-----------------------------------------------------------------------------
	HRESULT d3d9_wave_file::reset_file()
	{
		if( m_bIsReadingFromMemory )
		{
			m_pbDataCur = m_pbData;
	...
	//       Reset() is called.
	//-----------------------------------------------------------------------------
	HRESULT d3d9_wave_file::read( BYTE* pBuffer, DWORD dwSizeToRead, DWORD* pdwSizeRead )
	{
		if( m_bIsReadingFromMemory )
		{
			if( m_pbDataCur == NULL )
	...
	//-----------------------------------------------------------------------------
	// Name: d3d9_wave_file::Close()
	// Desc: Closes the wave file
	//-----------------------------------------------------------------------------
	HRESULT d3d9_wave_file::close()
	{
		if( m_dwFlags == WAVEFILE_READ )
		{
			mmioClose( m_hmmio, 0 );
			m_hmmio = NULL;
			AUTO_DELETE_ARRAY( m_pResourceBuffer );
		}
		else
		{
	...
	//-----------------------------------------------------------------------------
	// Name: d3d9_wave_file::WriteMMIO()
	// Desc: Support function for reading from a multimedia I/O stream
	//       pwfxDest is the WAVEFORMATEX for this new wave file.
	//       m_hmmio must be valid before calling.  This function uses it to
	//       update m_ckRiff, and m_ck.
	//-----------------------------------------------------------------------------
	HRESULT d3d9_wave_file::write_mmio( WAVEFORMATEX *pwfxDest )
	{
	...
	//-----------------------------------------------------------------------------
	// Name: d3d9_wave_file::Write()
	// Desc: Writes data to the open wave file
	//-----------------------------------------------------------------------------
	HRESULT d3d9_wave_file::write( UINT nSizeToWrite, BYTE* pbSrcData, UINT* pnSizeWrote )
	{
		UINT cT;
