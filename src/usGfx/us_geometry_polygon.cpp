...
namespace uniscope_globe
{
	...
	void geometry_polygon::draw(render_argument* args)
	{
		...
		args->m_device->draw_line_strip((void*)m_line_array.begin()._Ptr, vertices_count, sizeof(position_color));

		args->m_device->draw_indexed_triangle_list(D3DFMT_INDEX16, (void*)m_vertex_array.begin()._Ptr, vertices_count,
			(ushort*)m_triangle_index.begin()._Ptr, m_triangle_index.size(),
