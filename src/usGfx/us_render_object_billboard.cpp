...
///////////////////////////////////////////////////////////////////////////
//
//  Filename: us_render_object_billboard.cpp
...
///////////////////////////////////////////////////////////////////////////
#include "stdafx.h"
#include "us_render_object_billboard.h"

namespace uniscope_globe
{
	render_object_billboard::render_object_billboard( void )
	{
	...
	void render_object_billboard::draw( render_argument* args )
	{
		...
		{
			rs.set_state( D3DRS_TEXTUREFACTOR, m_blend_color );	

			ts.set_state( 0, D3DTSS_COLOROP, D3DTOP_MODULATE );
			ts.set_state( 0, D3DTSS_COLORARG1, D3DTA_TEXTURE );
			ts.set_state( 0, D3DTSS_COLORARG2, D3DTA_TFACTOR );

			ts.set_state( 0, D3DTSS_ALPHAOP, D3DTOP_MODULATE );
			ts.set_state( 0, D3DTSS_ALPHAARG1, D3DTA_TEXTURE );
			ts.set_state( 0, D3DTSS_ALPHAARG2, D3DTA_TFACTOR );
		}
		...
		args->m_device->draw_triangle_strip( &m_vertex_array[0], 4, sizeof(position_texture) );

		args->m_device->pop_transform();
	}

	void render_object_billboard::set_matrix( matrix_4d& mat )
	{
		m_mat = mat;
	}

	void render_object_billboard::set_texture( hardware_texture* v_texture )
	{
		m_texture = v_texture;
	}

	void render_object_billboard::create_billboard( int bb_type, vector_3d v_locate, double v_width, double v_height )
	{
	...
	bool render_object_billboard::intersect( const ray<double>& a_ray, intersect_result& result )
	{
		bool b_ret = false;
