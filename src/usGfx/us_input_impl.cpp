...
#include <usGfx/us_keyboard_device_impl.h>
#include <usGfx/us_mouse_device_impl.h>
#include <usGfx/us_mouse_3d_device_impl.h>
#include <usGfx/us_joystick_device_impl.h>
#include <usGfx/us_message_argument.h>
...
namespace uniscope_globe
{
	...
	bool input_impl::register_input_device(const LPCTSTR device_name, input_device_base* input_device)
	{
		...
		m_input_device_map.insert(std::make_pair(device_name, input_device));
