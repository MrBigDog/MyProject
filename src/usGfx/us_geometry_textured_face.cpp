...
namespace uniscope_globe
{
	...
	void geometry_textured_face::draw( render_argument* args )
	{
		...
		args->m_device->draw_triangle_strip( m_vertex_array.begin()._Myptr, m_vertex_array.size(), sizeof(position_texture) );
...
// 	}
	...
	void geometry_textured_face::create_textured_face_vertical( vector<vector_3d> vers, double width, double width_grid, double length_scale, double length_begin )
	{
