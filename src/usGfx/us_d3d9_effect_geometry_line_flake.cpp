...
///////////////////////////////////////////////////////////////////////////
//
//  Filename: us_d3d9_effect_geometry_line_flake.cpp
//  Author  : Uniscope Team 
//  Modifier: Uniscope Team  
//  Created : 
//  Purpose : d3d9_effect_geometry_line_flake class
//	Reference : 
//
///////////////////////////////////////////////////////////////////////////
//#include "stdafx.h"
...
{
	d3d9_effect_geometry_line_flake::d3d9_effect_geometry_line_flake( render_device* device )
	...
	d3d9_effect_geometry_line_flake::~d3d9_effect_geometry_line_flake( void )
	{

	}

	bool d3d9_effect_geometry_line_flake::setup_handle( void )
	{
		if (m_d3dx_effect)
		{	
	...
	bool d3d9_effect_geometry_line_flake::set_transform( const matrix4<float>& wvp )
	{
	...
	bool d3d9_effect_geometry_line_flake::set_view_proj_matrix( const matrix4<float>& tm )
	{
	...
	bool d3d9_effect_geometry_line_flake::set_line_param( int view_port_width, int view_port_height, float line_width )
	{
