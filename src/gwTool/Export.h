#ifndef GWTOOL_EXPORT_H
#define GWTOOL_EXPORT_H 1
...
#  if defined( GWTOOL_LIBRARY_STATIC )
#    define GWTOOL_EXPORT
#  elif defined( GWTOOL_LIBRARY )
#    define GWTOOL_EXPORT   __declspec(dllexport)
#  else
#    define GWTOOL_EXPORT   __declspec(dllimport)
#  endif
#else
#  define GWTOOL_EXPORT
#endif  
