...
void  get_min_max_colors_dxt5_sse2(const unsigned __int8 *a1, unsigned __int8 *a2, unsigned __int8 *a3)
{
	__m128i v3; // xmm0@1
	__m128i v4; // xmm1@1
	__m128i v5; // xmm0@1
	...
	v3 = _mm_load_si128((const __m128i *)a1);
	v4 = v3;
	v5 = _mm_min_epu8(_mm_min_epu8(_mm_min_epu8(v3, *((__m128i *)a1 + 1)), *((__m128i *)a1 + 2)), *((__m128i *)a1 + 3));
	v6 = _mm_max_epu8(_mm_max_epu8(_mm_max_epu8(v4, *((__m128i *)a1 + 1)), *((__m128i *)a1 + 2)), *((__m128i *)a1 + 3));
	v7 = _mm_min_epu8(v5, _mm_shuffle_epi32(v5, -18));
	v8 = _mm_max_epu8(v6, _mm_shuffle_epi32(v6, -18));
	v9 = _mm_unpacklo_epi8(_mm_min_epu8(v7, _mm_shufflelo_epi16(v7, -18)), *(__m128i*)SIMD_SSE2_byte_0);
	v10 = _mm_unpacklo_epi8(_mm_max_epu8(v8, _mm_shufflelo_epi16(v8, -18)), *(__m128i*)SIMD_SSE2_byte_0);
	v11 = _mm_srl_epi16(_mm_sub_epi16(v10, v9), _mm_set_epi32(4,0,0,0));
	v12 = _mm_add_epi16(v9, v11);
	v13 = _mm_sub_epi16(v10, v11);
	*(dword *)a2 = _mm_cvtsi128_si32(_mm_packus_epi16(v12, v12));
	*(dword *)a3 = _mm_cvtsi128_si32(_mm_packus_epi16(v13, v13));
}
...
#if defined(DXT_INTR)
      GetMinMaxColors_Intrinsics( block, minColor, maxColor );
	  //get_min_max_colors_dxt5_sse2(block, minColor, maxColor );
#else
...
word ColorTo565( const byte *color )
{
	//return ( ( color[ 0 ] >> 3 ) << 11 ) |
		//( ( color[ 1 ] >> 2 ) <<  5 ) |
		//(   color[ 2 ] >> 3 );
	return ((unsigned int)*color >> 3) | 8 * (color[1] & 0xFC | 32 * (color[2] & 0xF8));
}

//unsigned int ColorTo565(const unsigned __int8 *a1)
//{
//	return ((unsigned int)*a1 >> 3) | 8 * (a1[1] & 0xFC | 32 * (a1[2] & 0xF8));
//}
