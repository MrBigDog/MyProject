...
///////////////////////////////////////////////////////////////////////////
//
//  Filename: us_match_model_f_filter.cpp
...
///////////////////////////////////////////////////////////////////////////
#include "stdafx.h"
#include "us_match_model_f_filter.h"

namespace uniscope_globe
{
	object_base* match_model_f_filter::parse( raw_buffer* in_buffer )
	{
	...
	/*			desc.m_transform.create_from_sphr(	center_sphr.x, 
					center_sphr.y, 
					model_pos_sphr.z, 
				...
				double x_off = ( model_pos_sphr.x - center_sphr.x ) * spherical_coords::s_semi_major * math_d::cos_( model_pos_sphr.y ) * 1000.0;
				double z_off = ( model_pos_sphr.y - center_sphr.y ) * spherical_coords::s_semi_major * 1000.0;
				matrix4<double> v_trans_mat = matrix4<double>::translation( x_off, 0.0, z_off );
				desc.m_transform.m_mat_tnb = v_trans_mat * desc.m_transform.m_mat_tnb;*/
