...
///////////////////////////////////////////////////////////////////////////
#include "stdafx.h"
#include "us_usm_filter_v1.h"

namespace uniscope_globe
{
	object_base* usm_filter_v1::parse( raw_buffer* v_buffer )
	{
		//return NULL;

		building_create_buffer* compress_buf = (building_create_buffer*)v_buffer;
		...
		uncompress_buf.m_height = compress_buf->m_height;

		model_lod_hardware_mesh* v_mesh = parse_model_lod_hardware_mesh( &uncompress_buf );
		
		AUTO_DELETE( v_uncompress_data );

		//if ( system_environment::s_enable_shadow && (v_mesh->m_edges.size() == 0 || v_mesh->m_face_normals.size()==0) )
		//{
		//	v_mesh->generate_edge_and_normal();
		//}
	...
	model_lod_hardware_mesh* usm_filter_v1::parse_model_lod_hardware_mesh( building_create_buffer* uncompress_buf )
	{
	...
	int usm_filter_v1::read_vertex( building_create_buffer* v_stream, model_lod_hardware_mesh* v_mesh )
	{
	...
	//int usm_filter_v1::read_index_attribute( building_create_buffer* v_stream, model_lod_hardware_mesh* v_mesh )
	//{
	//	int v_readed_bytes = 0;
	...
	int usm_filter_v1::read_figure( building_create_buffer* v_stream, model_lod_hardware_mesh* v_mesh )
	{
		int v_readed_bytes = 0;
	...
	int usm_filter_v1::read_topologic( building_create_buffer* v_stream, model_lod_hardware_mesh* v_mesh )
	{
		int v_readed_bytes = 0;
	...
	int usm_filter_v1::read_aabb( building_create_buffer* v_stream, model_lod_hardware_mesh* v_mesh )
	{
	...
	int usm_filter_v1::read_material( building_create_buffer* v_stream, model_lod_hardware_mesh* v_mesh )
	{
		int v_readed_bytes = 0;
