...
///////////////////////////////////////////////////////////////////////////
//
//  Filename: us_match_model_filter.cpp
...
///////////////////////////////////////////////////////////////////////////
#include "stdafx.h"
#include "us_match_model_filter.h"

namespace uniscope_globe
{
	match_model_filter::match_model_filter( void )
	{
	...
	object_base* match_model_filter::parse( raw_buffer* in_buffer )
	{
		...
		for ( int i = 0; i < (int)num_of_model_set; i++ )
		{
			...
			for ( int j = 0; j< (int)number_of_model; j++ )
			{
				...
				desc.m_transform.create_from_sphr(	model_pos_sphr.x, 
												...
												model_rotation.y * RADIAN - HALF_PI,
