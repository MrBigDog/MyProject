...
#	define	INTERIOR_INDEX_LEVEL(id)	((int)(((id)>>48) & MASK_5_BITS))
	...
	public:
		...
		static void get_int_rect(const lon_lat_rect& rect, int level, int& north_index, int& south_index, int& east_index, int& west_index);

	public:
		static ustring to_encrypt_string(interior_index index);
		static ustring to_string(interior_index index);
		static ustring to_wmts_string(interior_index index);
	...
	public:
		...
		void get_int_rect(const lon_lat_rect& rect, int level, int& north_index, int& south_index, int& east_index, int& west_index);
