...
namespace uniscope_globe
{
	...
	bool lon_lat_rect::intersect(const lon_lat_region& in_region) const
	{
		...
		for (unsigned int i = 0; i < rect_pos_array.size(); i++)
		{
	...
	double lon_lat_rect::get_width(void) const
	{
		return m_east - m_west;
	}

	double lon_lat_rect::get_height(void) const
	{
