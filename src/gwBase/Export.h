#ifndef GWBASE_EXPORT_H
#define GWBASE_EXPORT_H 1
...
#  if defined( GWBASE_LIBRARY_STATIC )
#    define GW_BASE_EXPORT
#  elif defined( GWBASE_LIBRARY )
#    define GW_BASE_EXPORT   __declspec(dllexport)
#  else
#    define GW_BASE_EXPORT   __declspec(dllimport)
#  endif
#else
#  define GW_BASE_EXPORT
#endif  
