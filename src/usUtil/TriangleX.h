...
public:
	...
	struct triangulateio *GetOut();
	struct triangulateio *GetVorout();

	void Clear(struct triangulateio *t);  //清除占用的内存空间
	void ResetContent();
	void Build(char *triswitches, struct triangulateio *in);
};
