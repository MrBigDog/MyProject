...
std::string to_str(const osg::Vec2& v, int align = -1)
{
...
std::string to_str(const osg::Vec3& v, int align = -1)
{
	std::string res = align >= 0 ?
...
std::string to_str(const osg::Vec4& v, int align = -1)
{
	std::string res = align >= 0 ?
...
std::string to_str(const osg::Quat& q, int align = -1)
{
	std::string res = align >= 0 ?
...
std::string to_str(const osg::Matrixd& m, int align = -1)
{
	std::string result;
...
std::string to_str(const rot& r, int align = -1)
{
	return SSTR("(" << r.yaw << " " << r.pitch << " " << r.roll << ")");
}

std::string to_str(const trans& t, int align = -1)
{
