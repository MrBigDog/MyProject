#ifndef GWUTIL_EXPORT_H
#define GWUTIL_EXPORT_H 1
...
#  if defined( GWUTIL_LIBRARY_STATIC )
#    define GWUTIL_EXPORT
#  elif defined( GWUTIL_LIBRARY )
#    define GWUTIL_EXPORT   __declspec(dllexport)
#  else
#    define GWUTIL_EXPORT   __declspec(dllimport)
#  endif
#else
#  define GWUTIL_EXPORT
#endif  
