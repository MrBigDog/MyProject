#ifndef OSGEARTHFEATRUESEXT_H
#define OSGEARTHFEATRUESEXT_H 1
...
#  if defined( OSGEARTHFEATRUESEXT_LIBRARY_STATIC )
#    define OSGEARTHFEATRUESEXT_EXPORT
#  elif defined( OSGEARTHFEATRUESEXT_LIBRARY )
#    define OSGEARTHFEATRUESEXT_EXPORT   __declspec(dllexport)
#  else
#    define OSGEARTHFEATRUESEXT_EXPORT   __declspec(dllimport)
#  endif
#else
#  define OSGEARTHFEATRUESEXT_EXPORT
#endif  
