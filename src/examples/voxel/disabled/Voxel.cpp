...
Voxel::Voxel(osg::Vec3 dim, osg::Vec3d pos, int cornerWeight, BlockType blockType) 
...
Voxel::Voxel(osg::Vec3 dim, osg::Vec3d pos, BlockType blockType)
	: _geode(new osg::Geode())
	, _position(pos)
	, _blockType(blockType)
	, _geom(new osg::Geometry)
...
Voxel::Voxel() 
	...
	, _geom(new osg::Geometry)
	, _blockType(BlockType::BlockType_Default)
	, _cornerWeight(0) 
{
