...
void StringTokenizer::addDelim(char delim, bool keep)
{
	_delims[delim] = keep;
}

void StringTokenizer::addDelims(const std::string& delims, bool keep)
{
	for (unsigned i = 0; i < delims.size(); ++i)
		addDelim(delims.at(i), keep);
}

void StringTokenizer::addQuote(char quote, bool keep)
{
	_quotes[quote] = keep;
}

void StringTokenizer::addQuotes(const std::string& quotes, bool keep)
{
	for (unsigned i = 0; i < quotes.size(); ++i)
		addQuote(quotes.at(i), keep);
}

void StringTokenizer::tokenize(const std::string& input, StringVector& output) const
{
	output.clear();
...
const std::string gwUtil::EMPTY_STRING;

std::string gwUtil::toLegalFileName(const std::string& input)
{
...
unsigned gwUtil::hashString(const std::string& input)
{
...
std::string gwUtil::hashToString(const std::string& input)
{
...
osg::Vec4f gwUtil::htmlColorToVec4f(const std::string& html)
{
	std::string t = gwUtil::toLower(html);
...
std::string gwUtil::vec4fToHtmlColor(const osg::Vec4f& c)
{
	std::stringstream buf;
	buf << "#";
...
osg::Vec4ub gwUtil::stringToColor(const std::string& str, osg::Vec4ub default_value)
{
...
std::string gwUtil::colorToString(const osg::Vec4ub& c)
{
	std::stringstream ss;
...
osg::Vec3f gwUtil::stringToVec3f(const std::string& str, const osg::Vec3f& default_value)
{
...
std::string gwUtil::vec3fToString(const osg::Vec3f& v)
{
	std::stringstream buf;
...
std::string& gwUtil::replaceIn(std::string& s, const std::string& sub, const std::string& other)
{
...
std::string& gwUtil::ciReplaceIn(std::string& s, const std::string& pattern, const std::string& replacement)
{
...
*/
void gwUtil::trim2(std::string& str)
{
...
*/
std::string gwUtil::trim(const std::string& in)
{
	std::string str = in;
	trim2(str);
	return str;
...
std::string gwUtil::joinStrings(const StringVector& input, char delim)
{
	std::stringstream buf;
...
std::string gwUtil::toLower(const std::string& input)
{
...
std::string gwUtil::prettyPrintTime(double seconds)
{
...
std::string gwUtil::prettyPrintSize(double mb)
{
	std::stringstream buf;
...
bool gwUtil::ciEquals(const std::string& lhs, const std::string& rhs, const std::locale& loc)
{
...
bool gwUtil::startsWith(const std::string& ref, const std::string& pattern, bool caseSensitive, const std::locale& loc)
{
...
bool gwUtil::endsWith(const std::string& ref, const std::string& pattern, bool caseSensitive, const std::locale& loc)
{
	if (pattern.length() > ref.length())
		return false;
