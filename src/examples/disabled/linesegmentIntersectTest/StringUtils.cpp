...
std::string toLegalFileName(const std::string& input)
{
...
osg::Vec4f htmlColorToVec4f(const std::string& html)
{
...
std::string vec4fToHtmlColor(const osg::Vec4f& c)
{
	std::stringstream buf;
	buf << "#";
...
osg::Vec4ub stringToColor(const std::string& str, osg::Vec4ub default_value)
{
...
std::string colorToString(const osg::Vec4ub& c)
{
	std::stringstream ss;
...
osg::Vec3f stringToVec3f(const std::string& str, const osg::Vec3f& default_value)
{
...
std::string vec3fToString(const osg::Vec3f& v)
{
	std::stringstream buf;
...
std::string joinStrings(const StringVector& input, char delim)
{
	std::stringstream buf;
...
bool ciEquals(const std::string& lhs, const std::string& rhs, const std::locale& loc)
{
...
bool startsWith(const std::string& ref, const std::string& pattern, bool caseSensitive, const std::locale& loc)
{
...
bool endsWith(const std::string& ref, const std::string& pattern, bool caseSensitive, const std::locale& loc)
{
	if (pattern.length() > ref.length())
		return false;
